          ...
          child: Scaffold(
            appBar: AppBar(
              title: Text(
                ...
                style: TextStyle(
                    fontFamily: 'Inter', color: Colors.white, fontSize: 16.sp),
              ),
            ),
            body: MobileScanner(
                ...
                children: [
                  ...
                  Center(
                        child: Container(
                          ...
                          child: halalCubit.isHalal!=null?Image.asset(
                            halalCubit.isHalal!?'assets/img/halal_confirm.png':'assets/img/not_halal_confirm.png',
                            height: 166.h,
                            width: 152.w,
                          ):const SizedBox(),
                    ),
