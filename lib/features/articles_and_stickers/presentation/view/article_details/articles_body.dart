      ...
      builder: (context, state) {
        ...
        return state is GetArticlesError || state is GetSectionsFailure
          ...
          children: [
              ...
              child: Directionality(
                ...
                child: ClipRRect(
                  ...
                  child: ListView.separated(
                      ...
                      return InkWell(
                        onTap: () {
                          navigateTo(context, ArticleDetailsPage(
                            doorName: articlesCubit.allBlogsModel
                                .data[index].title,
                              htmlFreeContent: articlesCubit.allBlogsModel
                                  .data[index].htmlFreeContent,
                              title: articlesCubit.allBlogsModel
                                  .data[index].title,
                              content: articlesCubit.allBlogsModel
                                  .data[index].content,
                              picture: articlesCubit.allBlogsModel
                                  .data[index].images.isNotEmpty ? articlesCubit
                                  .allBlogsModel
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Padding(
                                    ...
                                    Container(
                                      ...
                                      child: Html(
                                        data: articlesCubit.allBlogsModel
                                            .data[index].content,
                              ...
                              SizedBox(height: 8.h),
                              Center(
                                child: articlesCubit.allBlogsModel
                    ...
                    itemCount:
                    articlesCubit.allBlogsModel.data.length,
                  ),
                ),
              ),
            ),
                  ...
                  child: Column(
                    children: [
                      ...
                      IconButton(onPressed: () {
                        if (articlesCubit.page == 1 &&
                            articlesCubit.allBlogsModel.links.next.isNotEmpty) {
                          articlesCubit.getMoreArticles(
                              path: articlesCubit.allBlogsModel.links.next);
                        }
                        else {
                          if (articlesCubit.newBlogsModel.links.next
                              .isNotEmpty) {
                            articlesCubit.getMoreArticles(
                                path: articlesCubit.newBlogsModel.links.next);
                          }
                        }
            ...
            if(articlesCubit.newBlogsModel.links.next.isEmpty)
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: SizedBox(
                    width: 190.w,
